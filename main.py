...
if funct == 'all':
    ...
    if funct == 'movies' or apollo == 'false':
        ...
        listhandler.parseIPTVLists(funct, providerurl, directory, None, path, None, 46, int(uid), int(gid))
    elif funct == 'events':
        listhandler.parseIPTVLists(funct, providerurl, directory, None, None, path, 16, int(uid), int(gid))
